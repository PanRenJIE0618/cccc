...
let activeImg = computed<any>(() => (item: { title: string, name: string,active:string }) => {
  ...
  return new URL("/image/bottom/" + img + ".png", import.meta.url).href;
});
...
let mod = reactive<Array<object>>([
  {
    title: "数据分析",
    image: new URL("/image/bottom/fx-bottom_Data_analysis.png", import.meta.url).href,
    name: "Data",
    active: "fx-bottom_Data_analysis"
  },
  {
    title: "人房管理",
    image: new URL("/image/bottom/fx-bottom_Human_housing_management.png", import.meta.url).href,
    name: "management",
    active: "fx-bottom_Human_housing_management"
  },
  {
    title: "应急演练",
    image: new URL("/image/bottom/fx-bottom_Emergency_drill.png", import.meta.url).href,
    name: "drill",
...
.fx-bottom_toolbar {
  ...
  width: 100%;
  height: 95px;
  background: url("/image/bottom/fx-bottom_background.png") no-repeat 0 5px;
  position: absolute;
  bottom: 0;
  display: flex;
