...
let SunData = reactive<Array<Sum>>([
  {
    name: "面积",
    img: new URL("/image/HHM/fx-HHM_area.png", import.meta.url).href,
    value: "78556"
  },
  {
    name: "开发商",
    img: new URL("/image/HHM/fx-HHM_developers.png", import.meta.url).href,
    value: "银基发展（上海）投资控股有限公司"
  },
  {
    name: "建筑面积",
    img: new URL("/image/HHM/fx-HHM_construct.png", import.meta.url).href,
    value: "420658"
  },
  {
    name: "规划户数",
    img: new URL("/image/HHM/fx-HHM_tenement.png", import.meta.url).href,
    value: "2000"
  },
  {
    name: "产权年限",
    img: new URL("/image/HHM/fx-HHM_population.png", import.meta.url).href,
    value: "70"
  },
]);
  ...
  <div class="fx-HHM">
    <div class="fx-HHM_Table" v-if="TableBox">
      ...
      <div class="fx-HHM_Table_content">
        <div class="fx-HHM_Table_content_head">
          <p>
            <img src="/image/HHM/fx-HHM_Table_content_head_icon.png" alt="">
            <span>银河丽湾</span>
          </p>
          <p>
    ...
    <div class="fx-HHM_SumData">
      ...
      <div class="fx-HHM_SumData_img">
        <img src="/image/HHM/fx-HHM_SumData_img.png" alt="">
...
.fx-HHM {
  ...
  &_Table {
    width: 353px;
    height: 818px;
    background: url("/image/HHM/fx-HHM_background.png") no-repeat;
    position: fixed;
    bottom: 85px;
    left: 30px;
    ...
    &_title {
      width: 353px;
      height: 32px;
      background: url("/image/HHM/fx-HHM_head_background.png") no-repeat;
      color: white;
      font-size: 16px;
      padding-left: 40px;
      line-height: 32px;
    ...
    &_content {
      ...
      &_head {
        width: 323px;
        height: 84px;
        background: url("/image/HHM/fx-HHM_Table_content_head_background.png") no-repeat;
  ...
  .fx-HHM_SumData {
    ...
    right: 20px;
    bottom: 86px;
    background: url("/image/HHM/fx-HHM_SumData_background.png") no-repeat;
