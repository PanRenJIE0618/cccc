  ...
  <div class="fx-viewpoint_box" v-if="viewpointBox">
    <div class="fx-viewpoint_box_head">
      <div class="fx-viewpoint_box_title">
        <img src="/image/viewpoint/fx-viewpoint_box_eye.png" alt="">
        <span>视点定位</span>
      </div>
      <img @click="closeView" class="fx-viewpoint_box_close" src="/image/viewpoint/fx-viewpoint_box_close.png"
           alt="">
    </div>
    <div class="fx-viewpoint_box_content">
      <div class="fx-viewpoint_box_content_vp">
        <div class="fx-viewpoint_box_content_vp_t" v-for="(item,index) in ViewPointList.slice(start,end)" :key="index"
          ...
          <div class="fx-viewpoint_box_content_addViewPoint" v-if="index === (start)" @click="addViewPoint">
            <img src="/image/viewpoint/fx-viewpoint_box_addViewPoint_icon.png" alt="">
            <span>新增视点</span>
          </div>
      ...
      <img @click="PageUp" class="fx-viewpoint_box_leftArrow" src="/image/viewpoint/fx-viewpoint_box_Leftarrow.png"
           alt="">
      <img @click="PageDown" class="fx-viewpoint_box_RightArrow"
           src="/image/viewpoint/fx-viewpoint_box_Rightarrow.png" alt="">
    </div>
  </div>
...
let viewer: any = {};
const NameInput = ref();
let viewpointBd: any = ref(new URL("/image/viewpoint/fx-ViewPoint_background.png", import.meta.url).href);
...
let ViewPointList = reactive<Array<object>>([
  {
    name: "add",
    image: new URL("/image/viewpoint/fx-viewpoint_box_addViewPointBackground.png", import.meta.url).href,
    disabled: true
  },
  {
    name: "南郊能源大厦",
    image: new URL("/image/viewpoint/ds.png", import.meta.url).href,
    position: {
...
let OpenViewPoint: () => any = function (): any {
  let vw = new URL("/image/viewpoint/fx-ViewPoint_background.png", import.meta.url).href;
  let vws = new URL("/image/viewpoint/fx-viewpoint_background_select.png", import.meta.url).href;
...
let closeView: () => any = function (): any {
  ...
  viewpointBd.value = new URL("/image/viewpoint/fx-ViewPoint_background.png", import.meta.url).href;
};
//翻页
...
.fx-viewpoint_box {
  ...
  background: url("/image/viewpoint/fx-viewpoint_box_background.png") no-repeat;
  ...
  .fx-viewpoint_box_content {
    ...
    .fx-viewpoint_box_content_vp {
      ...
      .fx-viewpoint_box_content_vp_t {
        ...
        height: 140px;
        margin: 0 10px;
        background: url("/image/viewpoint/fx-viewpoint_box_addViewPointBackground.png") no-repeat;
        position: relative;
        ...
        .fx-viewpoint_box_content_mask {
          ...
          .fx-viewpoint_box_content_mask_compile {
            background: url("/image/viewpoint/fx-viewpoint_box_edit.png") no-repeat;
          }

          .fx-viewpoint_box_content_mask_flight {
            background: url("/image/viewpoint/fx-viewpoint_box_flight.png") no-repeat;
          }

          .fx-viewpoint_box_content_mask_BoxDelete {
            background: url("/image/viewpoint/fx-viewpoint_box_delete.png") no-repeat;
          }
        }
      }
    }
